...
public abstract class SteeringAgentOptimisticInitialisation implements AgentInterface {
    ...
    public void agent_init(String taskSpecification) 
    {
        ...
        for(int i = 0 ; i < numPolicies ; i++) {
            ValueFunction vf = new WSLookupTable( numObjectives, numActions, numStates, 200, weights[i] );
    ...
    public Action agent_start(Observation observation) 
    {
    	...
    	double[] QValue = valueFunction.getQValues( action , state );
//    	for(int j = 0; j<QValue.length; j++)
//    	{
//    		System.out.println(QValue[j]);
//    	}
