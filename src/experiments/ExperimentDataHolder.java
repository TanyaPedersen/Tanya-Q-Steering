...
public class ExperimentDataHolder 
{
	...
	private String SCALAR_METRIC_NAME[] = {"Additive epsilon"};	
	...
	public void setEpisodeData(int o, double thisReward[], double thisTarget[])
	{
		...
		double thisMetric = calculateMetric(thisReward, thisTarget);
		...
		scalarisedMeanEpisodeReward[o] = calculateMetric(meanEpisodeReward[o], thisTarget);
		episodeCount[o]++;
	}
    ...
    private double calculateMetric(double thisReward[], double target[])
    {
    	switch (metric)
    	{
    		case ADDITIVE_EPSILON: return additiveEpsilon(thisReward, target);
    		default: return -999;
    	}
    }    
